<?php get_header(); ?>
	<div class="main">
		...
		<!--Изображения-->
		<h2>Images</h2>
		<p><img src="<?php echo get_template_directory_uri(); ?>/images/img1.jpg"><img src="<?php echo get_template_directory_uri(); ?>/images/img2.jpg"><img src="<?php echo get_template_directory_uri(); ?>/images/img3.jpg"><img src="<?php echo get_template_directory_uri(); ?>/simages/img4.jpg"></p>
